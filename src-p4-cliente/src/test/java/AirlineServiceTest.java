...
public class AirlineServiceTest {
    ...
    private AirlineService service = new RemoteAirlineService();
    ...
    void tryCreateAirportNullCode() {
        ...
        try {
            service.createAirport(iataCode, cityName, airportName, longitude, latitude);
    ...
    void tryCreateAircraftNullManufacturer() {
        ...
        int cols = 6;
        try {
            service.createAircraft(manufacturer, model, rows, cols);
    ...
    void testCreateFlightNullOrigin() {
        try {
            Airport destination = service.createAirport("LHR", "London", "London Heathrow Airport", -0.461389, 51.477500);
            AircraftType aircraft = service.createAircraft("Airbus", "A318", 22, 6);
            service.createFlight(null, destination.getIataCode(), aircraft.getId());
    ...
    void testCreateFlightNullDestination() {
        try {
            Airport origin = service.createAirport("MAD", "Madrid", "Barajas International Airport", -3.566764, 40.493556);
            AircraftType aircraft = service.createAircraft("Airbus", "A318", 22, 6);
            service.createFlight(origin.getIataCode(), null, aircraft.getId());
    ...
    void testCreateFlightNullAircraft() {
        try {
            Airport origin = service.createAirport("MAD", "Madrid", "Barajas International Airport", -3.566764, 40.493556);
            Airport destination = service.createAirport("LHR", "London", "London Heathrow Airport", -0.461389, 51.477500);
             service.createFlight(origin.getIataCode(), destination.getIataCode(), null);
    ...
    void testCreateFlightNonExistingOrigin() {
        try {
            Airport destination = service.createAirport("LHR", "London", "London Heathrow Airport", -0.461389, 51.477500);
            AircraftType aircraft = service.createAircraft("Airbus", "A318", 22, 6);
            service.createFlight("XXX", destination.getIataCode(), aircraft.getId());
    ...
    void testCreateFlightNonExistingDestination() {
        try {
            Airport origin = service.createAirport("MAD", "Madrid", "Barajas International Airport", -3.566764, 40.493556);
            AircraftType aircraft = service.createAircraft("Airbus", "A318", 22, 6);
            service.createFlight(origin.getIataCode(), "XXX", aircraft.getId());
    ...
    void testCreateFlightNonExistingAircraft() {
        try {
            Airport origin = service.createAirport("MAD", "Madrid", "Barajas International Airport", -3.566764, 40.493556);
            Airport destination = service.createAirport("LHR", "London", "London Heathrow Airport", -0.461389, 51.477500);
            service.createFlight(origin.getIataCode(), destination.getIataCode(), 666L);
    ...
    void testCreateFlightSameOriginAndDestination() {
        try {
            ...
            AircraftType aircraft = service.createAircraft("Airbus", "A318", 22, 6);
            service.createFlight(origin.getIataCode(), destination.getIataCode(), aircraft.getId());
